                ...
                <div className='col-md-7'>
                    <div className='download'>
                        ...
                        <div className='flex w-fit gap-3'>
                            <Image src={IMAGES.HomeGoogleStore} alt="Banner1" className="scale_img max-w-[150px] cursor-pointer" />
                            <Image src={IMAGES.HomeAppStore} alt="Banner1" className="scale_img max-w-[150px] cursor-pointer" />
                        </div>
                    </div>
