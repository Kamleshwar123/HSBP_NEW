...
const ProductBox = () => {
    ...
    return (
        <div className='overflow-hidden shadow-4D h-full rounded-3xl bg-white border-2 border-[#DCDCDC] text-center cursor-pointer' onClick={()=> router.push("/products/1")}>
            <div>
                ...
                <div className='pb-5 px-5 mt-4'>
                    ...
                    <button className='custom_button mt-5' onClick={(e)=> {e.stopPropagation(); router.push("/product-cart")}}>Add to Cart</button>
                </div>
            </div>
        </div>
    )
