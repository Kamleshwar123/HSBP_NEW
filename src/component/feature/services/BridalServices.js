...
const BridalServices = () => {
  ...
  return (
    <div className='container'>
        ...
        />
        <div className='px-3 text-theme text-center font-semibold text-2xl md:text-4xl'>Normal Packages</div>
        <div className='mt-7 mb-7'>
            <BridalPackageSlider/>
        </div>
        <div className='px-3 text-theme text-center font-semibold text-2xl md:text-4xl'>Premium Packages</div>
        <div className='mt-7'>
            <BridalPackageSlider/>
        </div>
    </div>
